...
void lattice_Evolution(vector<vector<double> > &lattice,unsigned int length,double t_step,unsigned int iterations)
{
	...
	default_random_engine generator(random_device{}());
 	...
 	double acceptance =0,delta_H_Average=0,temp=0,temp1=0,temp2=0,error_x2=0,error_x=0,mu = -10,lamba = 0.1;
 ...
 #if !Oscillator_flip
 		acceptance += hmcAlgorithm_Anharmonic(length,t_step,State,temp_State,H_store,mu,lamba,steps);
 #endif
